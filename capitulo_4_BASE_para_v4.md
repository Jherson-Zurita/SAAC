...
***Figura 4.5. Esquema de Disposición del Layout GraphForge UI en 5 Regiones.***  
*Fuente: Elaboración propia.*
...
***Figura 4.6. Vista Previa de Diagrama C4 en el Canvas de SAAC v2.0.***  
*Fuente: Elaboración propia.*
...
***Figura 4.7. Mapa de Calor de Acoplamiento (Coupling Matrix Heatmap).***  
*Fuente: Elaboración propia.*
...
***Figura 4.8. Chat del Asistente de IA con Renderizado de Markdown y Resaltado de Sintaxis.***  
*Fuente: Elaboración propia.*
...
***Figura 4.9. Diagrama de Flujo del Mecanismo de Fallback del Cliente de IA.***  
*Fuente: Elaboración propia.*
...
***Figura 4.10. Ejemplo de Payload JSON/Texto Generado por build_prompt para la IA.***  
*Fuente: Elaboración propia.*
...
***Figura 4.11. Salida de Consola Real de la Prueba de Contrato de Workers.***  
...
***Figura 4.12. Salida de Consola Real de la Prueba de Pipeline de Análisis.***  
*Fuente: Ejecución propia sobre entorno Python 3.11.*
...
***Figura 4.13. Salida de Consola Real de la Prueba de Resolutores de Imports.***  
*Fuente: Ejecución propia sobre entorno Python 3.11.*
...
***Figura 4.14. Salida de Consola Real de la Prueba de Antipatrones.***  
...
***Figura 4.15. Salida de Consola Real de la Prueba de Diagramas C4.***  
*Fuente: Ejecución propia sobre entorno Python 3.11.*
...
***Figura 4.16. Salida de Consola Real de la Prueba de Diagramas Suplementarios.***  
*Fuente: Ejecución propia sobre entorno Python 3.11.*
...
***Figura 4.17. Salida de Consola Real de la Prueba de Integración de IA.***  
*Fuente: Ejecución propia sobre entorno Python 3.11.*
